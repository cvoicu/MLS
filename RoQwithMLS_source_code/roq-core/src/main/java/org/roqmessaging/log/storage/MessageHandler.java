...
public class MessageHandler {
	...
	public MessageHandler(LogConfigDAO properties, Context context, String nodeName, String logInAddress, int configPort) {
		this.properties = properties;
		this.nodeName = nodeName;
		this.inproc = context.socket(ZMQ.PUSH);
		this.inproc.bind("inproc://"+this.nodeName+configPort);
