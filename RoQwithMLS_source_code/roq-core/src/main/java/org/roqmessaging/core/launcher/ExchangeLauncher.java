...
public class ExchangeLauncher {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (args.length != 7) {
			System.out
					.println("The argument should be <int front port> <int back port> < tcp:// monitor:monitorPort> <tcp:// monitor:statport> <String logAdress:port> <String seed#seed#...> <propFile>");
			return;
		}
		...
		System.out.println("LogAddress: "+ args[4] +", ListOfSeeds: "+ args[5] +", propFile: "+ args[6]);
		...
		try {
			...
			final Exchange exchange = new Exchange(frontPort, backPort, args[2], args[3], args[4], args[5], args[6]);
			// Launch the thread
