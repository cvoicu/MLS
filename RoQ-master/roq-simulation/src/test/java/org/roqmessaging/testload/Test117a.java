...
public class Test117a extends RoQTestCase {
	...
	public void test117a() throws InterruptedException {
		...
		SenderLoader loader1 = new SenderLoader(3000, 20, RoQUtils.getInstance().getLocalIP(), qName, 1);
		SenderLoader loader2 = new SenderLoader(3000, 20, RoQUtils.getInstance().getLocalIP(), qName, 2);
		SenderLoader loader3 = new SenderLoader(3000, 20, RoQUtils.getInstance().getLocalIP(), qName, 3);
		...
		SenderLoader loader11 = new SenderLoader(100, 5, RoQUtils.getInstance().getLocalIP(), qName, 11);
		// Schedule it, the run will be called soon
		timerLoad.schedule(loader11, 50, 1000);
		Thread.sleep(30000);
		//Close all
		timerLoad.cancel();
